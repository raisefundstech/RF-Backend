    ...
    if (response)
      return res
        ...
        .json(
          new apiResponse(
            200,
            responseMessage.addDataSuccess("meet our team"),
            response
          )
        );
    else
...
export const updateOurTeam = async (req: Request, res: Response) => {
  ...
  let response: any,
    body = req.body;
  try {
    response = await ourTeamModel.findOneAndUpdate(
    ...
    if (response)
      return res
        ...
        .json(
          new apiResponse(
            200,
            responseMessage.updateDataSuccess("meet our team"),
            response
          )
        );
    else
      return res
        ...
        .json(
          new apiResponse(
            400,
            responseMessage.updateDataError("meet our team"),
            {}
          )
        );
  } catch (error) {
    ...
    if (response)
      return res
        ...
        .json(
          new apiResponse(
            200,
            responseMessage.getDataSuccess("meet our team"),
            response
          )
        );
    else
      return res
        ...
        .json(
          new apiResponse(
            400,
            responseMessage.getDataNotFound("meet our team"),
            {}
          )
        );
  } catch (error) {
